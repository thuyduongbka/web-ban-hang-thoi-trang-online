			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*">
						All Products (<?php echo e($product->count()); ?>)
					</button>
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".<?php echo e($type->ID); ?>">
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<div class="filter-col1 p-r-15 p-b-27">
							...
							<ul>								
								<li class="p-b-6">
									<a href="<?php echo e(asset('/sort/asc')); ?>" class="filter-link stext-106 trans-04">
										Price: Low to High
									</a>
								</li>

								<li class="p-b-6">
									<a href="<?php echo e(asset('/sort/desc')); ?>" class="filter-link stext-106 trans-04">
										Price: High to Low
									</a>
								</li>
							</ul>
						...
						<div class="filter-col3 p-r-15 p-b-27">
							...
							<ul>
								...
								<li class="p-b-6">
									<span class="fs-15 lh-12 m-r-6" style="color: <?php echo e($co->inforColor); ?>;">
										<i class="zmdi zmdi-circle"></i>
									</span>

									<a href="<?php echo e(asset('search/color/'.$co->ID)); ?>" class="filter-link stext-106 trans-04">
										<?php echo e($co->ColorName); ?>
