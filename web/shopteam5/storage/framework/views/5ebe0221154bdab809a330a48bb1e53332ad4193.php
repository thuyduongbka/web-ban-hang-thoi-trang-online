...
<!---------------------------------------------------------------------------------------------------------->                      
                      <form accept-charset="utf-8" action="<?php echo e(asset('login')); ?>" method="post" class="simform">     
                        <fieldset>
                          ...
                          <div class="simform__actions">                          
                            ...
                            <span class="simform__actions-sidetext">
                              <a href="<?php echo e(asset('/forgotpw/')); ?>" class="special" role="link" href="#">Forgot your password?<br>Click here</a></span>
                          </div>   
                        </fieldset>                                 
